...
function getNativeMapName(navigationMode) {
...
function getNativeComponentName(component) {
...
exports.googleMapIsInstalled = !!react_native_1.UIManager.hasViewManagerConfig(getNativeMapName(false));
function decorateMapComponent(Component, componentName, providers) {
    const components = {};
    const getDefaultComponent = () => (0, react_native_1.requireNativeComponent)(getNativeComponentName(componentName));
    ...
    Component.prototype.getNativeComponent =
        function getNativeComponent() {
            ...
            const nativeComponentName = getNativeComponentName(componentName);
    ...
    Component.prototype.getMapManagerCommand = function getMapManagerCommand(name) {
        const nativeComponentName = `${getNativeComponentName(componentName)}Manager`;
